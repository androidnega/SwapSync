  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        given_phone_color: form.given_phone_color.trim() || null,
        given_phone_storage: form.given_phone_storage.trim() || null,
        given_phone_ram: form.given_phone_ram.trim() || null,
