...
const ProfitReports: React.FC = () => {
  ...
  const generateHubProfitsReport = (data: any) => {
    ...
    const productsHub = hub_profits?.products_hub || {};
    const swappingHub = hub_profits?.swapping_hub || {};
    const repairerHub = hub_profits?.repairer_hub || {};
    const summaryData = summary || {};
    
    return `
${company_name?.toUpperCase() || 'SWAPSYNC'}
${report_title || 'Hub Profits Report'}
Generated: ${generated_at ? new Date(generated_at).toLocaleString() : new Date().toLocaleString()}
...
PROFIT SUMMARY
═══════════════════════════════════════════════════════════════
Total Profit: ₵${summaryData?.total_profit?.toFixed(2) || '0.00'}
Products Profit: ₵${summaryData?.products_profit?.toFixed(2) || '0.00'}
Swapping Profit: ₵${summaryData?.swapping_profit?.toFixed(2) || '0.00'}
Repairs Profit: ₵${summaryData?.repairs_profit?.toFixed(2) || '0.00'}
...
PRODUCTS HUB:
- Revenue: ₵${productsHub?.revenue?.toFixed(2) || '0.00'}
- Cost: ₵${productsHub?.cost?.toFixed(2) || '0.00'}
- Profit: ₵${productsHub?.profit?.toFixed(2) || '0.00'}

SWAPPING HUB:
- Profit: ₵${swappingHub?.profit?.toFixed(2) || '0.00'}
- Note: ${swappingHub?.note || 'Profit from resold phones'}

REPAIRER HUB:
- Service Revenue: ₵${repairerHub?.service_revenue?.toFixed(2) || '0.00'}
- Items Revenue: ₵${repairerHub?.items_revenue?.toFixed(2) || '0.00'}
- Items Profit: ₵${repairerHub?.items_profit?.toFixed(2) || '0.00'}
- Total Profit: ₵${repairerHub?.total_profit?.toFixed(2) || '0.00'}
