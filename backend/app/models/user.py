...
class User(Base):
    ...
    use_company_sms_branding = Column(Integer, default=0, nullable=True, server_default='0')  # 1=use company name in SMS, 0=use SwapSync (nullable for migration compatibility)
